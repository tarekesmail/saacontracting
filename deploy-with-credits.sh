...
# SAA Contracting - Deploy with Credits System
# Enhanced deployment script that adds credit/deposit management

set -e  # Exit on any error

echo "🚀 SAA Contracting - Deploy with Credits System"
echo "==============================================="
...
if [ $DB_EXISTS -eq 1 ]; then
    echo "📊 Database exists - will add credits system"
    PRESERVE_DATA=true
else
...
# Add user management and credits system to existing database
...
echo "   ✅ Transaction status tracking (Pending/Confirmed/Cancelled)"
echo "   ✅ Accountant information recording"
echo "   ✅ Net balance calculations"
echo "   ✅ Comprehensive filtering and reporting"
echo ""
...
echo "   3. Go to Credits page to manage deposits/withdrawals"
echo "   4. Assign appropriate roles (Admin/Read Only)"
echo "   5. Create or select tenants for data management"
echo ""
...
echo "   Credit records in system: $CREDITS_COUNT"
