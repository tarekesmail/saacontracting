...
# SAA Contracting - Deploy with User Management
# Enhanced deployment script that adds user management system

set -e  # Exit on any error

echo "🚀 SAA Contracting - Deploy with User Management"
echo "==============================================="
...
if [ $DB_EXISTS -eq 1 ]; then
    echo "📊 Database exists - will add user management"
    PRESERVE_DATA=true
else
...
# Add user management to existing database
...
echo "   3. Assign appropriate roles (Admin/Read Only)"
echo "   4. Create or select tenants for data management"
echo ""
